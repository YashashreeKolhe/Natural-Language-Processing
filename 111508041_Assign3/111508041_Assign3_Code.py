...
def main():
    fw = open('bigram-output.txt', 'w')
    fw1 = open('trigram-output.txt', 'w')
    fw2 = open('four-gram-output.txt', 'w')
    fw3 = open('five-gram-output.txt', 'w')
    f = open(sys.argv[1], 'r')
    ...
    for line in f:
        ...
        for word in list_of_split_words_on_spaces:
            ...
            if value == False:
                ...
                if flag == 0:
                    list_of_split_words.append(word)
        for index in range(0, len(list_of_split_words) - 1):
            fw.write(list_of_split_words[index] + " " + list_of_split_words[index+1] + "\n")
            fw.flush()
        for index in range(0, len(list_of_split_words) - 2):
            fw1.write(list_of_split_words[index] + " " + list_of_split_words[index+1] + " " + list_of_split_words[index+2] + "\n")
            fw1.flush()
        for index in range(0, len(list_of_split_words) - 3):
            fw2.write(list_of_split_words[index] + " " + list_of_split_words[index+1] + " " + list_of_split_words[index+2] + " " + list_of_split_words[index+3] + "\n")
            fw2.flush()
        for index in range(0, len(list_of_split_words) - 4):
            fw3.write(list_of_split_words[index] + " " + list_of_split_words[index+1] + " " + list_of_split_words[index+2] + " " + list_of_split_words[index+4] + " " + list_of_split_words[index+4] + "\n")
            fw3.flush()
        list_of_split_words[:] = []
    fw.close()
    fw1.close()
